...
const FailSection = (
  ...
  return (
    <div className="h-full flex flex-col justify-center max-w-screen-lg mx-auto px-5 pb-5"><div className="flex flex-col justify-center mt-10"><p className=" text-black text-center text-2xl text-bold">Sorry, you got rugged</p>
      ...
      <button className="mt-10"><a href = "/myrecord" className="text-[#008BF0] text-center text-sm hover:text-linkhighlight">Show My Record</a></button><p className=" text-black mt-10 text-center text-lg text-bold">Share the result</p>
